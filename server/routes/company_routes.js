...
// Get company data
router.get("/company", get_company_data);

// Post a job
router.post("/post-job", post_job);

// Get applicants data of company
router.get("/applicants", get_company_job_applicants);

// Get company job list
router.get("/list-jobs", get_company_posted_jobs);

// Change application status
router.post("/change-status", change_job_applications_status);

// Change applications visibility
router.post("/change-visibility", change_visibility);

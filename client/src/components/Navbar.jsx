      ...
      <div className="navbar relative backdrop-blur-lg">
        <div className="flex items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-5">
            ...
            <div className="text-gray-800 dark:text-gray-300 flex items-center gap-4 sm:gap-6 font-outfit max-lg:hidden">
              ...
              <div className="relative group flex items-center gap-1 text-sm sm:text-base cursor-pointer transition-colors hover:text-black/70 dark:hover:text-gray-400">
                ...
                <div className="absolute z-20 top-10 right-0 p-2 dark:bg-gray-950 bg-gray-200 backdrop-blur-xl rounded-xl flex flex-col gap-1 min-w-48 shadow-lg border border-gray-300 dark:border-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
          ...
          <div className="flex items-center gap-2">
            {user ? (
              <div className="dark:text-white/80 flex items-center gap-1 sm:gap-2 text-sm sm:text-base">
                {SearchAndTheme}
                <div className="">
                  <button className="invisible hidden sm:block sm:visible p-2 cursor-pointer bg-gray-200/50 dark:bg-gray-900 rounded-full dark:hover:bg-gray-800 hover:bg-gray-300 transition">
